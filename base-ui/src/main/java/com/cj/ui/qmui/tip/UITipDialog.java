...
public class UITipDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public UITipDialog create(boolean cancelable) {
            ...
            dialog.setContentView(R.layout.base_ui_qmui_tip_dialog_layout);
            ...
            if (mCurrentIconType == ICON_TYPE_LOADING) {
                ...
                loadingView.setSize(ScreenUtil.INSTANCE.dip2px(mContext, 32));
                ...
                loadingViewLP.topMargin=ScreenUtil.INSTANCE.dip2px(mContext,20);
                ...
                if (mCurrentIconType == ICON_TYPE_SUCCESS) {
                    imageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.base_ui_qmui_icon_notify_done));
                } else if (mCurrentIconType == ICON_TYPE_FAIL) {
                    imageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.base_ui_qmui_icon_notify_error));
                } else {
                    imageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.base_ui_qmui_icon_notify_info));
                }
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                if (mCurrentIconType != ICON_TYPE_NOTHING) {
                    tipViewLP.topMargin = ScreenUtil.INSTANCE.dip2px(mContext, 12);
                }
