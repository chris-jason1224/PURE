...
import com.cj.compressor.core.EasyCompressor;import com.cj.compressor.util.ScreenUtilKt;
...
public class CompressUtil {
    ...
    private Bitmap scaledCompress(String path) {
        ...
        //屏幕宽高
        int screenWidth = ScreenUtilKt.getScreenWidth(EasyCompressor.getContext());
        int screenHeight = ScreenUtilKt.getScreenHeight(EasyCompressor.getContext());
    ...
    private Bitmap scaledCompressWithFactor(String path) {
        ...
        //屏幕宽高
        int screenWidth_f = ScreenUtilKt.getScreenWidth(EasyCompressor.getContext()) * 3 /10 ;
        int screenHeight_f = ScreenUtilKt.getScreenHeight(EasyCompressor.getContext()) * 3 /10;
